...
paymentsCltr.pay = async(req,res)=>{
    ...
    const body = pick(req.body,['invoiceId','categoryName','amount'])
    try{
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items:[{
                price_data:{
                    ...
                    unit_amount:body.categories.amount * 100
                },
                quantity: 1
            }],
            mode:"payment",
        ...
        payment.categories.name=body.categories.name
        payment.amount = Number(body.categories.amount)
